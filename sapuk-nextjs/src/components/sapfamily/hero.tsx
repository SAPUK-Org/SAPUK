      ...
      <div className="flex flex-col items-stretch gap-10 lg:flex-row lg:gap-12">
        <div className="flex-1 space-y-6">
          ...
          <p className="max-w-xl text-base leading-relaxed text-zinc-600 sm:text-lg">
            ...
            this so that you can feel welcome and understand who you are
            creating safe spaces with — building bonds in a friendly manner, as
            encouraged by counsellors and therapists.
          </p>
          <TeamStatsBar />
        </div>
